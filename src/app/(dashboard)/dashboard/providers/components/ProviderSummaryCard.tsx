...
export default function ProviderSummaryCard({
  ...
  const categories = [
    ...
    { key: "oauth", color: "bg-blue-600", label: t("oauthLabel"), stat: summaryStats.oauth },
    {
      key: "ide",
      color: "bg-sky-600",
    ...
    { key: "no-auth", color: "bg-gray-500", label: t("noAuthLabel"), stat: summaryStats.noauth },
    {
      key: "upstream-proxy",
      color: "bg-indigo-600",
    ...
    { key: "apikey", color: "bg-amber-600", label: t("apiKeyLabel"), stat: summaryStats.apikey },
    {
      key: "compatible",
      color: "bg-slate-500",
